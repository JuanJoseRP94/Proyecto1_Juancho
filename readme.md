...
Objetivo: Aprender a limpiar, visualizar y trabajar con datos.

Link del dataset elegido: https://www.kaggle.com/datasets/bobbyscience/league-of-legends-diamond-ranked-games-10-min/data

Los datos consisten en partidas online de 2 equipos(rojo vs azul) compitiendo entre sí(los datos icluyen solo los 10 primeros minutos). Tendremos diferentes valores, como: Oro obtenido, muertes, asesinatos, visión, dragones, etc.

Contamos con aproximadamente 10000 partidas asi que tenemos datos suficientes.
